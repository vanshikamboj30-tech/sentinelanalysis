...
import { Home, Video, VideoOff, AlertTriangle, FileText, MessageSquare, Bell, BarChart3 } from "lucide-react";
import { toast } from "sonner";
import { useAlertNotifications } from "@/hooks/useAlertNotifications";
import ChatInterface from "@/components/sentinel/ChatInterface";
import AnalyticsCharts from "@/components/sentinel/AnalyticsCharts";
...
Report generated by SENTINEL AI System
  ...
  const setupAlertNotifications = async () => {
    const highThreatEvents = detections.filter((d) => d.threat > 70);
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Detections Log, Chat, or Analytics */}
          {showChat ? (
